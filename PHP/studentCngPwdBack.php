<?php
  ...
  if(mysqli_num_rows($res) > 0)
  {
    if($cpwd == $row["password"])
    {
      ...
      {
        echo "<script>alert('Password Not Match'); window.location.href='../PHP/studentCngPwd.php';</script>";
      }
    }
  }
  else echo "<script>alert('Not Successful'); window.location.href='../PHP/studentHome.php';</script>";
?>
